...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Profil Staff')</title>
...
<aside class="sidebar">
    ...
    <div class="profile-box">
        @if(auth()->user()->profile_image)
            <img src="{{ asset('storage/' . auth()->user()->profile_image) }}" alt="Staff Avatar">
        @else
            <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=1a73e8&color=fff" alt="Staff Avatar">
        @endif
